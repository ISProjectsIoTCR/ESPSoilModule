...
String ssidArr[] = {"IoTCR"};
int ssidArrNo = 1;

const char* ssid = ""; // no need to fill in
const char* password = "Ioticos17" ;
...
//iotcrV2 CONEXION
const char broker[] = "54.151.121.38";
int        port     = 1883;
String dId = "0001";
String webhook_pass = "7Fq5RRVLte";
String webhook_endpoint = "http://54.151.121.38:3001/api/getdevicecredentials";
